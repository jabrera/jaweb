		...
		<div id="center">
			<div id="content_pad">
				...
				<div id="center_base">
					...
					<span class="title"><img src="images/skin/default/bg/mini_icon.png" class="mini_icon_l">About This Website</span><hr class="dashed_lg">
					...
					<p>This website is compatible in any browsers such as Mozilla Firefox, Google Chrome, Safari, Opera and more except Internet Explorer (all versions). The minimum requirement of the screen resolution is not less than 950px in width. This website is also hosted by www.000webhost.com. This website used HTML5, and CSS3 for design, and PHP, and mySQL for database.</p>
					<p>This design is the second version while you can also see the first version <a href="http://www.jaweb.comze.com/version/1/">here</a>.
					<p>A quick video how I created the first version of this website.<br><br><iframe width="560" height="315" src="http://www.youtube.com/embed/OXN1asgGlOo" frameborder="0" allowfullscreen></iframe></p>
					<p><a href="http://www.jaweb.comze.com/version/2/webdeveloper/">More about the Web Developer.</a></p>
					</div>
				</div>
			</div>
		</div>
