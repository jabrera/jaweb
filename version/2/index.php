				...
				<div id="center_base">
					<div id="center_it">
						<div id="center_divider">
							<div id="center_d_pad1">
								<span class="title"><img src="images/skin/default/bg/mini_icon.png" class="mini_icon_l">Latest Tutorials</span><hr class="dashed_lg">
								<?php
								...
								while ($row=mysql_fetch_array($query)) {
									...
									echo '
								<a href="http://www.jaweb.comze.com/version/2/watch.php?category='.$link_category.'&id='.$id.'&h='.$h.'" alt="'.$title.'" title="'.$title.'"><div id="latest_vid_desc" style="background:url(http://img.youtube.com/vi/'.$video.'/0.jpg) no-repeat center center;">
									<div id="black_bottom">
								...
								<hr class="dashed_lg">
								<p class="date_posted">Date Posted: '.$date_added.'</p>
									';
									$ab = 1;
								}
								if($ab==0) {
									echo 'There are no tutorials posted.
									';
								}
								?>
							</div>
						...
						<div id="center_divider">
							<div id="center_d_pad2">
								<span class="title"><img src="images/skin/default/bg/mini_icon.png" class="mini_icon_l">News and Updates</span><hr class="dashed_lg">
								...
								while($row = mysql_fetch_array($query)) {
									...
									$date_added = $row['date_added'];
									echo '<span class="blog_title">'.$title.'</span><br>'.$message.'
								<hr class="dashed_lg">
								<p class="date_posted">Date Posted: '.$date_added.'</p>
								';
								}
