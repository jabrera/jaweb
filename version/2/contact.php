		...
		<div id="center">
			<div id="content_pad">
				...
				<div id="center_base">
					...
					<span class="title"><img src="images/skin/default/bg/mini_icon.png" class="mini_icon_l">Contact</span><hr class="dashed_lg">
					Here you can submit your messages/ suggestions/ request about this website.
					<form action="http://jaweb.comze.com/version/2/contact_msg.php?webaction=contact" method="post">
					<table cellpadding="10" style="padding-left:30px;padding-top:20px;font-size:13px;">
						<?php
						if(isset($_GET['error'])) {
							$error = $_GET['error'];
							if($error == 1) {
								echo '
						<tr>
							<td colspan="2"><span class="error">Please fill up the form correctly.</span></td>
						</tr>
						';
							} elseif ($error == 2) {
								echo '
						<tr>
							<td colspan="2"><span class="error">Verification code incorrect.</span></td>
						</tr>
						';
							} elseif ($error == 3) {
								echo '
						<tr>
							<td colspan="2"><span class="error">Invalid email.</span></td>
						</tr>
						';
							} else {
							...
							if($success == 1) {
								echo '
						<tr>
							<td colspan="2"><span class="message">Your message has been sent.</span></td>
						</tr>
						';
							}
						}
						?>
						<tr>
							<td>Title</td><td><input type="text" name="title" class="text_default" placeholder="Title"></td>
						</tr>
						<tr>
							<td>Full Name</td><td><input type="text" name="fullname" class="text_default" placeholder="Full Name"></td>
						</tr>
						<tr>
							<td>Email</td><td><input type="text" name="email" class="text_default" placeholder="Email"></td>
						</tr>
						<tr valign="top">
							<td>Message</td><td><textarea class="text_default" row="15" name="message" placeholder="Message"></textarea></td>
						</tr>
						<?php
						$num1 = rand(1, 50);
						$num2 = rand(1, 10);
						...
						?>
						<tr>
							<td valign="top">Verify</td><td><?php echo $num1.' + '.$num2; ?><br><br><input type="text" name="verify" class="text_default" placeholder="Sum of two numbers"></textarea></td>
						</tr>
						<tr valign="top">
							<td><input type="hidden" name="ans" value="<?php echo $ans; ?>"></td><td><input type="submit" style="margin-left:0px;width:250px;" class="submit_default" value="Send"></td>
						</tr>
					</table>
					</form>
					</div>
