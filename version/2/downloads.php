		...
		<div id="center">
			<div id="content_pad">
				...
				<div id="center_base">
					...
					<span class="title"><img src="images/skin/default/bg/mini_icon.png" class="mini_icon_l">Downloads</span><hr class="dashed_lg">
					<?php
					$query = mysql_query("SELECT * FROM downloads ORDER BY id DESC");
					while($row = mysql_fetch_array($query)) {
						$name = $row['name'];
						$image = $row['image_name'];
						$image = 'images/skin/default/downloads/'.$image.'.jpg';
						$file = $row['file_name'];
						if(!file_exists($image)) {
							$image = 'images/skin/default/downloads/noimg.jpg';
						}
						echo '
							<div id="uni_options">
							<img src="http://www.jaweb.comze.com/version/2/'.$image.'" width="120"><table style="border:0px solid transparent;float:left;font-size:13px;width:80%"><tr><td><b>'.$name.'</b></td><td align="right"><a href="http://www.jaweb.comze.com/version/2/files/'.file.'" class="dl_button">Download</a></td></tr></table>
							</div>
						';
					}
					?>
