	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / <a href="index.php">Posts Management</a> / Edit
				</div>
				...
				<center><table class="admin_table" cellspacing="0">
					<tr>
						<td colspan="2"><center><b>Edit Post</td>
					</tr>
					<tr>
					...
					<tr>
						<td></td><td><input type="submit" value="Edit" class="admin_button"></td>
					</tr>
				</table>
				</form>
			</div>
