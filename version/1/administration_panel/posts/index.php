	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / Posts Management
				</div>
				...
				<table width="100%" class="admin_table" cellspacing="0">
					...
					echo '
					<tr>
						<td><center><b>List of Posts ('.$num.')</td>
						<td width="100px" align="right"><a href="new.php">New Post</a></td>
					</tr>
					';
					$n = 0;
					...
					<tr>
						<td>'.$title.'</td>
						<td align="right"><a href="edit.php?id='.$id.'">Edit</a> | <a href="../process.php?table=posts&action=delete&id='.$id.'">Delete</a></td>
					</tr>
					';
						$n = 1;
					}
					if ($n == 0) {
						echo '
					<tr>
						<td colspan="2"><center><b>No post.</td>
					</tr>
					';
					}
					?>
