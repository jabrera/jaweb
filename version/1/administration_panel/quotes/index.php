	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / Web Quotes Management
				</div>
				...
				<table width="100%" class="admin_table" cellspacing="0">
					<?php
					$query = mysql_query("SELECT * FROM webquotes ORDER BY id DESC");
					$num = mysql_num_rows($query);
					echo '
					<tr>
						<td><center><b>List of Web Quotes ('.$num.')</td>
						<td width="150px" align="right"><a href="new.php">New Quote</a></td>
					</tr>
					';
					$n = 0;
					while($row = mysql_fetch_array($query)) {
						$id = $row['id'];
						$quote = $row['quote'];
						$quote = substr($quote,0,50);
						$quoted_by = $row['quoted_by'];
						echo '
					<tr>
						<td>'.$quote.'... - '.$quoted_by.'</td>
						<td align="right"><a href="../process.php?table=webquotes&action=delete&id='.$id.'">Delete</a></td>
					</tr>
					';
						$n = 1;
					}
					if ($n == 0) {
						echo '
					<tr>
						<td colspan="2"><center><b>No web quotes.</td>
					</tr>
					';
					}
					?>
