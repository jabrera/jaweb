	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / <a href="index.php">Web Quotes Management</a> / New
				</div>
				<p class="post_info">Welcome, <?php echo $loggeduser; ?>! [<a href="../logout.php">Logout</a>]</p>
				<br>
				<form action="../process.php?table=webquotes&action=new" method="post">
				<center><table class="admin_table" cellspacing="0">
					<tr>
						<td colspan="2"><center><b>Add a New Quote</td>
					</tr>
					<tr>
						<td>Quoted By:</td><td><input type="text" name="quoted_by" class="admin_text"></td>
					</tr>
					<tr valign="top">
						<td>Quote</td><td><textarea name="quote" class="admin_text"></textarea></td>
					</tr>
					<tr>
						<td></td><td><input type="submit" value="Send" class="admin_button"></td>
					</tr>
				</table></center>
				</form>
			</div>
