	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / <a href="index.php">Tutorials Management</a> / Edit
				</div>
				...
				?>
				<form action="../process.php?table=tutorials&action=edit&id=<?php echo $id; ?>" method="post">
				<center><table class="admin_table" cellspacing="0">
					<tr>
						<td colspan="2"><center><b>Create New Tutorial</td>
					</tr>
					<tr>
						<td>Title</td><td><input type="text" name="title" class="admin_text" value="<?php echo $title; ?>"></td>
					</tr>
					<tr valign="top">
						<td>Message</td><td><textarea name="message" class="admin_text"><?php echo $message; ?></textarea></td>
					</tr>
					<tr>
						<td>Category</td><td><select name="category">
							<option value="HTML" <?php if($category == 'HTML') {echo 'selected="selected"';} ?>>HTML</option>
							<option value="CSS" <?php if($category == 'CSS') {echo 'selected="selected"';} ?>>CSS</option>
							<option value="PHP" <?php if($category == 'PHP') {echo 'selected="selected"';} ?>>PHP</option>
							<option value="mySQL" <?php if($category == 'mySQL') {echo 'selected="selected"';} ?>>mySQL</option>
							<option value="Turbo C" <?php if($category == 'Turbo C') {echo 'selected="selected"';} ?>>Turbo C</option>
							<option value="Photoshop" <?php if($category == 'Photoshop') {echo 'selected="selected"';} ?>>Photoshop</option>
							<option value="Others" <?php if($category == 'Others') {echo 'selected="selected"';} ?>>Others</option>
						</select></td>
					</tr>
					<tr>
						<td>Video ID</td><td><input type="text" name="video" value="<?php echo $video; ?>" class="admin_text"></td>
					</tr>
					<tr>
