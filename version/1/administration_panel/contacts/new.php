	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / <a href="index.php">Contacts Management</a> / New Email
				</div>
				<p class="post_info">Welcome, <?php echo $loggeduser; ?>! [<a href="../logout.php">Logout</a>]</p>
				<br>
				<form action="../process.php?table=contacts&action=new" method="post">
				<center><table class="admin_table" cellspacing="0">
					<tr>
						<td colspan="2"><center><b>Create New Email</td>
					</tr>
					<tr>
						<td>To</td><td><input type="text" name="email" class="admin_text"></td>
					</tr>
					<tr>
