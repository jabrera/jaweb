	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / <a href="index.php">Contacts Management</a> / View
				</div>
				...
				if(isset($_GET['id'])) {
					...
					while($row = mysql_fetch_array($query)) {
						...
						echo '<h2>'.$title.'</h2><hr class="small_line">
						<p class="post_info">Sent By: '.$fullname.' &lt;'.$email.'&gt;<br>'.$date_added.'</p>
						<p>'.nl2br($message).'</p>';
					}
					$read = 1;
					mysql_query("UPDATE contacts SET read_e='$read' WHERE id='$id' LIMIT 1");
					if($n == 0) {
