	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / Contacts Management
				</div>
				...
				<table class="admin_table" width="100%" cellspacing="0">
					...
					<?
					$query = mysql_query("SELECT * FROM contacts ORDER BY date DESC");
					$n = 0;
					while($row = mysql_fetch_array($query)) {
						...
						if($read == 0) {
							...
							$new = 'style="font-weight:normal"';
						}
						echo '
					<tr>
						<td><a href="view.php?id='.$id.'" '.$new.'>'.$title.'</a></td>
						<td>'.$from.'</td>
						<td colspan="2"><a href="../process.php?table=contacts&action=delete&id='.$id.'">Delete</a></td>
					</tr>
					';
						$n = 1;
					}
					if($n==0) {
						echo '
					<tr>
						<td colspan="3"><p align="center">There are no emails sent</p></td>
					</tr>';
					}
					?>
				</table>
