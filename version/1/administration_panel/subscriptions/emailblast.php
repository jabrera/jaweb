	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / <a href="index.php">Subscriptions Management</a> / Email Blast
				</div>
				<p class="post_info">Welcome, <?php echo $loggeduser; ?>! [<a href="../logout.php">Logout</a>]</p>
				<br>
				<form action="../process.php?table=subscription&action=emailblast" method="post">
				<center><table class="admin_table" cellspacing="0">
					<tr>
						<td colspan="2"><center><b>Send an Email Blast</td>
					</tr>
					<tr>
						<td>Subject</td><td><input type="text" name="subject" class="admin_text"></td>
					</tr>
					<tr valign="top">
