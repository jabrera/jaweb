	...
	<div id="content">
		<div id="admin_base">
			<div id="wrapper">
				...
				<a href="../index.php">Administration Login</a> / Subscriptions Management
				</div>
				...
				<table width="100%" class="admin_table" cellspacing="0">
					<?php
					mysql_query("UPDATE subscriptions SET new = 0");
					$query = mysql_query("SELECT * FROM subscriptions ORDER BY id DESC");
					$num = mysql_num_rows($query);
					echo '
					<tr>
						<td><center><b>List of Subscribed Emails ('.$num.')</td>
						<td width="150px" align="right"><a href="emailblast.php">Send an Email Blast</a></td>
					</tr>
					';
					$n = 0;
					...
					<tr>
						<td>'.$email.'</td>
						<td align="right"><a href="../process.php?table=subscription&action=delete&id='.$id.'">Delete</a></td>
					</tr>
					';
						$n = 1;
					}
					if ($n == 0) {
						echo '
					<tr>
						<td colspan="2"><center><b>No subscribed emails.</td>
					</tr>
					';
					}
					?>
