	...
	<div id="content">
		...
		<div id="center">
			<div id="wrapper">
				...
				<p>
				<center>
				<form action="http://jaweb.comze.com/version/1/contact_msg.php?webaction=contact" method="post">
				<table cellpadding="10">
					...
					?>
					<tr>
						<td>Title</td><td><input type="text" name="title" class="text" placeholder="Title"></td>
					</tr>
					<tr>
						<td>Full Name</td><td><input type="text" name="fullname" class="text" placeholder="Full Name"></td>
					</tr>
					<tr>
						<td>Email</td><td><input type="text" name="email" class="text" placeholder="Email"></td>
					</tr>
					<tr valign="top">
						<td>Message</td><td><textarea class="admin_text" name="message" placeholder="Message"></textarea></td>
					</tr>
					<?php
					$num1 = rand(1, 50);
					$num2 = rand(1, 10);
					...
					?>
					<tr>
						<td valign="top">Verify</td><td><?php echo $num1.' + '.$num2; ?><br><br><input type="text" name="verify" class="admin_text" placeholder="Sum of two numbers"></textarea></td>
					</tr>
					<tr valign="top">
						<td><input type="hidden" name="ans" value="<?php echo $ans; ?>"></td><td><input type="submit" class="button" value="Send"></td>
					</tr>
				</table>
				</form></center>
				</p>
