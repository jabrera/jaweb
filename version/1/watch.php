			...
			<div id="wrapper">
				...
				<div style="position:relative;display:inline-block;">
					<div id="vid_cate">
						...
						Date Posted: '.$date_added.'<br>
						</div>
					</div>
					<iframe width="850" height="478" src="http://www.youtube.com/embed/'.$video.'" style="border:5px solid transparent;outline:2px dashed #aa1616;"frameborder="0" allowfullscreen></iframe>
					<div id="vid_desc">
						<div id="vid_desc_pad">
							'.nl2br($message).'
							<div id="vid_views">
